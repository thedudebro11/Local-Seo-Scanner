...
function generateHtml(r: AuditResult, branding: ReportBranding = {}): string {
...
<div class="container">
  ...
  <div class="footer">
    ${branding.agencyName
      ? `Prepared by ${escHtml(branding.agencyName)}`
      : 'Generated by Local SEO Scanner'
    } &nbsp;·&nbsp; ${date} &nbsp;·&nbsp; Scan ID: ${escHtml(r.id)}
  </div>
